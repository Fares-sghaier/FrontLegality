...
const Dashboard = () => {
    ...
    try {
      if (filterBy && filterValue.trim() !== "") {
        const response = await axios.post(
          "https://legality-back1-production.up.railway.app/projects/filter",
          ...
          const projectsWithComments = await Promise.all(
            response.data.projects.map(async (project) => {
              ...
              const isLikedResponse = await axios.post(
                "https://legality-back1-production.up.railway.app/projects/isLiked",
                {
              ...
              const invitationResponse = await axios.post(
                "https://legality-back1-production.up.railway.app/projects/invitation",
                {
  ...
  const fetchSearchResults = async () => {
    try {
      const projectsResponse = await axios.post(
        "https://legality-back1-production.up.railway.app/projects/search",
  ...
  const fetchUserRatings = async (commentId: number) => {
    try {
      const response = await axios.post(
        "https://legality-back1-production.up.railway.app/projects/user-ratings",
        {
          id_user: user?.id_user,
  ...
  const handleRating = async (commentId, rating) => {
    try {
      ...
      const response = await axios.post(
        "https://legality-back1-production.up.railway.app/projects/add-rating",
        {
          id_comment: commentId,
          id_user: user?.id_user,
          rating: rating,
            ...
            projectsWithComments.map(async (project) => {
              const updatedComments = await Promise.all(
                project.comments.map(async (comment) => {
                  try {
                    const response = await axios.post(
                      "https://legality-back1-production.up.railway.app/projects/ratingPercentage",
  ...
  const fetchCommentsForProject = async (
    ...
    try {
      const response = await axios.post<{ comments: ProjectComment[] }>(
        "https://legality-back1-production.up.railway.app/projects/getAllComments",
        { id_project: projectId },
      );
  ...
  const fetchLikeCountForProject = async (projectId) => {
    try {
      const response = await axios.post(
        "https://legality-back1-production.up.railway.app/projects/liked",
        { id_project: projectId },
      );
  ...
  const fetchCommentCountForProject = async (
    ...
    try {
      const response = await axios.post<{ commentCount: number }>(
        "https://legality-back1-production.up.railway.app/projects/countComments",
        { id_project: projectId },
      );
  ...
  const handleAddComment = async (projectId: number, comment: string) => {
    try {
      const response = await axios.post(
        `https://legality-back1-production.up.railway.app/projects/addComment`,
        {
          id_project: projectId,
          id_user: user?.id_user,
          comment: comment,
  ...
  const handleUpdateComment = async (
    ...
    try {
      ...
      const response = await axios.put(
        `https://legality-back1-production.up.railway.app/projects/updateComment/${id_comment}`, // Note: The comment ID is now part of the URL
        {
          id_project: projectId,
          id_user: user?.id_user,
          comment: comment,
