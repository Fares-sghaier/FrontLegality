...
const SignupPage = () => {
  ...
  const handleSignInGoogle = () => {
    window.location.href = "https://legality-back1-production.up.railway.app/auth/google"; // Redirect to Google sign-in
  };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("https://legality-back1-production.up.railway.app/users/signup", user);
